    ...
    <div>
      ...
      <main className="max-w-7xl mx-auto px-8 sm:px-16">
        ...
        <section>
          ...
          <di className="flex space-x-3 overflow-scroll scrollbar-hide p-3 -ml-3">
...
export async function getStaticProps() {
  ...
  const liveAnywhereDataResponse = await fetch(
    'https://links.papareact.com/zp1'
  );
  const liveAnywhereData = await liveAnywhereDataResponse.json();
